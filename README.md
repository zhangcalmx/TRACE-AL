...
- **2026-09-08 重新核签**：规则文件的注释性清理（触发条件、权重、引用与证据均未变）改变了文件哈希，哈希记录已同步至清理后文件；证据指纹与 LightRAG 索引未变，无需重建。详见 `.executor/progress.json` 与 `data/processed/lightrag_index_20260825_113121/acceptance_manifest.json` 中的 recertification 块；
## 声明
